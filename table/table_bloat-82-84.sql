...
* This query is compatible with PostgreSQL 8.2 to 8.4
* Changelog:
*   * remove specific code for 7.4 to 8.1
*   * use server_version_num for version checking
*   * support varlen header of 1 or 4 bytes depending on data size in 8.3
*/
